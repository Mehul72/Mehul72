...
from svgkit import CACHE

SHELLS = glob.glob(os.path.expanduser("~/Library/Caches/ms-playwright/chromium_headless_shell-*/*/chrome-headless-shell"))
CHROME = SHELLS[-1] if SHELLS else "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
